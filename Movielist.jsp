...
<br>
<table bgcolor="black" cellspacing="10" cellpadding="10" align="center">
...
<c:if test="${!empty listMovies}">
	<table bgcolor="black"class="tg" cellspacing="20" cellpadding="10" align="center">
	<tr>
	...
	<c:forEach items="${listMovies}" var="movie">
		<tr>
			...
			<td>${movie.genre}</td>
			<td>${movie.rating}</td>
			<%-- <td><a href="<c:url value='/userRating/${movie.rating}' />" >Your rating</a></td> --%>
		</tr>
	</c:forEach>
	</table>
</c:if>
